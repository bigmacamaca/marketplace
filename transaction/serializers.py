...
class TransactionDisplaySerializer(serializers.ModelSerializer):
    ...
    seller_name = serializers.CharField(source='transaction_item.product.seller')

    class Meta:
        model = Transaction
        fields = ('number_identifier', 'product_name', 'product_image', 'seller_name', 'transaction_quantity', 'subtotal', 'buyer_name', 'checkout_date')
